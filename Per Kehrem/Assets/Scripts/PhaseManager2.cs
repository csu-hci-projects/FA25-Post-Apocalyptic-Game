...
public class PhaseManager2 : MonoBehaviour
{
    ...
    [SerializeField] private RottenFleshPattern rottenFleshPattern;
    ...
    private IEnumerator EnemyTurn()
    {
        ...
        IAttackPattern pattern = nextIsHayBales ? rottenFleshPattern : needlePattern;
...
public interface IAttackPattern2
{
    IEnumerator Execute();
}